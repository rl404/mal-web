...
export const ANIME_STATUS_PLANNED = 'Plan to Watch'
...
export const ANIME_STATUS_ID = {
  [ANIME_STATUS_WATCHING]: ANIME_STATUS_WATCHING_ID,
  [ANIME_STATUS_COMPLETED]: ANIME_STATUS_COMPLETED_ID,
  [ANIME_STATUS_ONHOLD]: ANIME_STATUS_ONHOLD_ID,
  [ANIME_STATUS_DROPPED]: ANIME_STATUS_DROPPED_ID,
  [ANIME_STATUS_PLANNED]: ANIME_STATUS_PLANNED_ID,
}
...
export const MANGA_STATUS_PLANNED = 'Plan to Read'
...
export const MANGA_STATUS_ID = {
  [MANGA_STATUS_READING]: MANGA_STATUS_READING_ID,
  [MANGA_STATUS_COMPLETED]: MANGA_STATUS_COMPLETED_ID,
  [MANGA_STATUS_ONHOLD]: MANGA_STATUS_ONHOLD_ID,
  [MANGA_STATUS_DROPPED]: MANGA_STATUS_DROPPED_ID,
  [MANGA_STATUS_PLANNED]: MANGA_STATUS_PLANNED_ID,
}
