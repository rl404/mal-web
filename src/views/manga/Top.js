          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={9}>
              <Grid container spacing={1} className={classes.content}>
                ...
                {props.mangalist && props.mangalist[state.data.id] ?
                  <Grid item>
                    <Tooltip placement='bottom' title={cons.MANGA_USER_STATUS[props.mangalist[state.data.id].status]}>
                      <span className={classes.user} style={{ backgroundColor: statusColor[props.mangalist[state.data.id].status] }} />
                    </Tooltip>
                  </Grid>
                  : null}
                <Grid item>
