...
const User = React.lazy(() => import('./views/user/profile'));
...
const routes = [
  ...
  { path: '/user/:username', exact: true, name: 'User Profile', component: User },
  { path: '/user', exact: true, name: 'User Form', component: User },
];
